...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      > 
        <div id="box-container" className={` absolute flex m-auto w-screen  inset-0  bg-purple-950/90 z-10 ${click==true?"h-10" :"h-0" } transition-all`}></div>
        <div id="text" className="z-30" onClick={()=>handleClick()}>signin</div>
      </div>
    </div>
